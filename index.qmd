...
ggplot(est_tariff_impact, aes(x = GDP_dec, y = Capital_stock_dec, color = tariff)) +
  geom_point(size = 5) +
  labs(x = "Percent GDP Decrease", y = "Percent Capital Stock Decrease", title = "Relationship Between Decrease of GDP & Capital Stock Due to Different Tariffs") 
```

## What Will Be The Effect Of Trump's Tariffs On The Country?
...
{{< video https://youtu.be/JUPJaqpVh_s >}}

<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vRJm6H14Z2J64b_RpIJFPeKt8phQMwETpk1uHVoGGf4b-5Ycrq8iMJv7MTqNlpYGHc_IZpH8mRUBdI2/pubembed?start=false&loop=false&delayms=3000" frameborder="0" width="960" height="569" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
